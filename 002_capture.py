...
# set up writer
writer1 = cv2.VideoWriter('002_video1.mp4v', cv2.VideoWriter_fourcc(*'mp4v'), 30, (width,height))
writer2 = cv2.VideoWriter('002_video2.mp4v', cv2.VideoWriter_fourcc(*'mp4v'), 30, (width,height))
